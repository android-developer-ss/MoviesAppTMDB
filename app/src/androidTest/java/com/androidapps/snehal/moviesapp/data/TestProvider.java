...
/**
 * Created by snehalsutar on 12/21/15.
 */
...
//                MovieEntry.buildMovieWithMovieId(movieId)); //.buildWeatherLocation(testLocation));
//        // vnd.android.cursor.dir/com.example.android.sunshine.app/weather
//        assertEquals("Error: the WeatherEntry CONTENT_URI with location should return WeatherEntry.CONTENT_ITEM_TYPE",
...
//        type = mContext.getContentResolver().getType(
//                MovieEntry.buildMovieWithRatingAndReleaseDate(rating, testDate));// buildWeatherLocationWithDate(testLocation, testDate));
...
//    }
    ...
    public void testBasicWeatherQuery() {
        ...
        ContentValues movieValues = TestUtilities.createMovieValues(); //createNorthPoleLocationValues();
        ...
        Cursor movieCursor = mContext.getContentResolver().query(
                MovieEntry.buildMovieWithMovieId("99999"),
                null,
                null,
                null,
                null
        ...
        Log.i("Cursor Object SVS test ", "---------"+ DatabaseUtils.dumpCursorToString(movieCursor));
...
//        SQLiteDatabase db = dbHelper.getWritableDatabase();
//
//        ContentValues testValues = TestUtilities.createMovieValues();// createNorthPoleLocationValues();
...
////                MovieEntry.bbuildWeatherLocation(TestUtilities.TEST_LOCATION),
////                null, // leaving "columns" null just returns all the columns.
////                null, // cols for "where" clause
////                null, // values for "where" clause
////                null  // sort order
...
//        weatherCursor = mContext.getContentResolver().query(
//                MovieEntry.buildMovieWithMovieId(TestUtilities.TEST_MOVIE_ID),
//                null, // leaving "columns" null just returns all the columns.
//                null, // cols for "where" clause
//                null, // values for "where" clause
//                null  // sort order
...
//        weatherCursor = mContext.getContentResolver().query(
//                MovieEntry.buildMovieWithRatingAndReleaseDate(TestUtilities.TEST_RATING,TestUtilities.TEST_DATE),
//                null,
//                null,
//                null,
//                null
...
//            testValues.put(MovieContract.MovieEntry.COLUMN_MOVIE_ID, 12345);
...
//        ContentValues values = TestUtilities.createMovieValues(); //.createNorthPoleLocationValues();
//
...
//        updatedValues.put(MovieEntry.COLUMN_MOVIE_OVERVIEW, "New Overview --Santa's Village");
//
